...
If your goal concerns an element of the world, something that concerns only your character, you get 0,5 BP if you succeeded or failed after a genuine attempt. If you worked towards it, you also get 0,5 BP.

With these bond points you can accomplish certain feats of strength and magic.

Make up a sentence that establishes your relationship (bond) with members of your party or an important NPC who tags along with the party. The details of what exactly each of these bonds entail will be solved at the table with everybody. Examples are as follow:
...
We will read out loud the bonds that players have. Each time the table feels that a bond has evolved you gain a bond point (for example: "___ does not trust me" changes because you made a significant thing to change that attitude during roleplay or a combat situation).

Bond points can be banked. Bond points can "buy" you special abilities.

|   |   |
|---|---|
|Amount of bond points spent|Ability|
|1|Get another round of combat or a +5 on an ability check/saving throw/attack roll or damage.|
|2|Use an ability available to your character or that of one of your allies (even if depleted).|
|4|Use a higher level ability of your character or that of one of your allies (discuss with DM about what ability makes most sense narratively).|
