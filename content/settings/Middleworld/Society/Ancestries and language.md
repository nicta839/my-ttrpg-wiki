...
There are several ancestries that can be traced in this world: Fey folk, Giant Spawn, Plane Touched, Dragon influenced, Old Races, Short Folk and humans.

The diagram to the right presents how (mechanical aspects of each) ancestries are related to each group. Physical anthropologist of the Middleworld have shown that groups around the Human group are related to adjacent groups (Fey Folk morphologies are related to both Giant Spawn and Short Folk). It is believed that these groups evolutions were facilitated by interactions with the Human group and the exposition to mana energies/wind. The Human group has been used as a reference frame to expose the difference in physical features with other ancestral groups.

## Physical features of each ancestral group:
...
There exist several languages that you can pick from depending on your background.

### Common languages:

Middlespeak: Most common language to all people
...
Runic: Language spoken by the Short Folk (Dwarven/Halfling gnomish)

New Fey: Language spoken by the Fey Folk (Elven)

### Rare languages:

Ancient Fey: as the name implies. Spoken by those fey that are of an older age and memory.

"Magic Runes": Written language used to set mana in certain configurations. Written language of modern spells.

Old Vallian: Archeological language. It is difficult to ascertain if it is made up of a single language. This language attests to your character's ability to decipher the meaning of old written text.

Draconic: Spoken to and with dragons.

Primordial: Spoken by those touched by the Elemental Planes.

Infernal: Spoken by those touched by the Negative Energy Plane

Celestial: Spoken by those touched by the Positive Evergy Plane..

Landspeak: Spoken by the Old People. (Druidic)
