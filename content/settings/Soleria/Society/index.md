...
<section class="index-guide">
  ...
  <div class="index-link-groups">
    <section class="index-link-group">
      ...
      <ul>
        <li><a href="/settings/soleria/society/ancestry">Ancestry</a></li>
        <li><a href="/settings/soleria/society/character-creation/">Character creation</a></li>
      </ul>
    </section>
    <section class="index-link-group">
