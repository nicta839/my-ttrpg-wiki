...
Aldrich's boots look normal, not like they've been down by the river. there is also an open box of herbs delivered from Greenleaf supplies - there is a kitchen.
...
Aldrich has been seeing a business downturn this year, which matches with the slower Inn.
	- Gossip lady -> judges
    - Nights mercy -> follow the poison order
    - Debt -> what kind of business was supposed to be discusses
    - Parchment -> who to meet at riverbank at dust
...
6. Seems like Tibin was the person Aldrich was supposed to meet at the riverbank
    ...
    - Marla greenleaf = clerk who sold night mercy => ask if she knows more
    - Hilda might know more about the debt and business challenges of Aldrich
    - Local drunk guy? (didnt follow too well, oops) 
    Aldrich hired people for this debate season, as past seasons, but then seems to have closed, but kept purchasing supplies.
...
Guard forces are very CSI...you know

Hilda is an elderly woman living next to a bakery. She is the gossip of town. She tells everything to the guard and takes pity on them sometimes. Objectifies big buff men.

<!-- vault-enrichment:start -->
## Related

- [[settings/Godshand/Campaign/Quests/index|Quests]]
